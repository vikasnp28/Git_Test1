<#
 ...
 $source = "C:\Projects\Github\Waldo\Dev-Studio-Waldo-MWS-FrW\Pipeline\DSC\$VMDesc\$($VMDesc)Config.ps1"
 $config = "C:\Projects\Github\Waldo\Dev-Studio-Waldo-MWS-FrW\Pipeline\DSC\$VMDesc\$($VMDesc)ConfigData.psd1"
 $configurationName = "$($VMDesc)Config"
